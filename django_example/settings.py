...
#    'link_root': 'site_media', # path snippet to media in url (no slashes).
    'file_root': 'django_example/media', # relative path to media from git root (no leading or trailing slash)
#    'debug': True, # Should probably keep True, prints out what it is changing.
    'blacklist': ['django_example/media/build'], # A list of substrings of source files+paths you don't want updated
    'trigger_file_sets': [ # a list of tuples where the left being in the name of a file that changed     triggers the right to be added to the list of files to update the version tags on.
        ...
        ('.js', 'django_example/media/build/site.js'), # If a js file is changed, also update django_example/media/build/site.js
        ('.css', 'django_example/media/build/style.css'), # If a css file is changed, also update django_example/media/build/style.css
    ],
...
STATIC_URL = BASE_URL + '/' + STATIC_URL_REL
...
SECRET_KEY = 'gkli(4fk1ncxla0b@1@$5q19o)lm2_s+@x#6cw2#8nftrd&bvx'
